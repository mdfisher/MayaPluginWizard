...
function AddConfig(proj, strProjectName)
{
	try
	{
		...
		var strMayaVersion = wizard.FindSymbol('MAYA_VERSION');
...
//		}
		...
		config.IntermediateDirectory = '$(ProjectName)\\$(PlatformName)\\$(ConfigurationName)';
		config.OutputDirectory = '$(ProjectName)\\$(PlatformName)\\$(ConfigurationName)';
		...
		debugSettings.PDBPath = '$(ProjectName)\\$(PlatformName)\\$(ConfigurationName)\\';
		...
		CLTool.PreprocessorDefinitions = 'WIN32,_DEBUG,_WINDOWS,_AFXDLL,_MBCS,NT_PLUGIN,REQUIRE_IOSTREAM,Bits64_,_BOOL';
		CLTool.WarningLevel = warningLevelOption.warningLevel_3;
		CLTool.PrecompiledHeaderFile = '$(ProjectName)\\$(PlatformName)\\$(ConfigurationName)\\' + strCommandName + '.pch';
		CLTool.Optimization = optimizeOption.optimizeDisabled;
		CLTool.RuntimeLibrary = runtimeLibraryOption.rtMultiThreadedDebugDLL;
		//MDF - These options are now taken care of by commands above.
		...
		LinkTool.OutputFile = 'C:\\Users\\mdfisher\\Documents\\maya\\' + strMayaVersion + '-' +  '$(PlatformName)' + '\\plug-ins\\' + strCommandName + '.mll';
		LinkTool.ImportLibrary = '$(ProjectName)\\$(PlatformName)\\$(ConfigurationName)\\' + strCommandName + '.lib';
		LinkTool.ProgramDatabaseFile = '$(ProjectName)\\$(PlatformName)\\$(ConfigurationName)\\' + strCommandName + '.pdb';
		LinkTool.AdditionalOptions = '/export:initializePlugin /export:uninitializePlugin';
		...
		CLTool.PreprocessorDefinitions = 'WIN32,NDEBUG,_WINDOWS,_AFXDLL,_MBCS,NT_PLUGIN,REQUIRE_IOSTREAM,Bits64_,_BOOL';
		CLTool.WarningLevel = warningLevelOption.warningLevel_3;
		...
		LinkTool.OutputFile = '$(MFROOT)\\MAYA\\' + strMayaVersion + '-' +  '$(PlatformName)' + '\\plug-ins\\' + strCommandName + '.mll';
